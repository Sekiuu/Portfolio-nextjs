...
function FeatureCard() {
    ...
    (<section className={sectionClass + ' lg:w-5/6 md:w-[90%] grid grid-cols-3 max-sm:grid-cols-2 gap-5 mx-auto p-5 bg-greenN rounded-xl shadow-md shadow-greenL/50'}>
    ...
    return (
        <>
            {/* features */}
            {featuresCard(6,'max-sm:hidden')}
            {featuresCard(4, "sm:hidden")}
        </>
    )
}
